    ...
    return function(selection) {
        ...
        if (!(/a\.tiles\.mapbox.com/).test(L.mapbox.config.HTTP_URL)) {
            ...
            layers = [{
                ...
                title: 'GAODE',
                layer: L.tileLayer('http://webrd02.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={x}&y={y}&z={z}', {
                    attribution: '&copy; <a href="http://amap.com">amap.com</a> contributors'
                })
            }
